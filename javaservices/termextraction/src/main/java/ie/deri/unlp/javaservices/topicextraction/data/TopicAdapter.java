package ie.deri.unlp.javaservices.topicextraction.data;
...
public class TopicAdapter {
	private static Logger logger = Logger.getLogger(TopicAdapter.class);
    ...
    private Topic createTopic(ExtractedTopic extractedTopic) {
        String rootSequence = extractedTopic.getRootSequence();
        Integer tokenCount = WordUtils.computeTokensNo(extractedTopic.getPattern());
